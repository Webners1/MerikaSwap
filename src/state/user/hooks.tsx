...
export function computePairAddress({
  ...
  return getCreate2Address(
    ...
    token0.chainId == 1 ? "0x284105c50b630ba152d66c7cc0721c3729f56026a8d71617578311e869c253bf" : token0.chainId === 204 ? "0x1937327f8450c08e13c394fdf74a14214c38e7dd4c42f26872824e8f78e08423": tokenA.chainId == 137 ? "0x75df2c56877e32c6cf5b6bae86b4df78f14dcc4566ead8468f91d83b7838b279": "0xe18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303"
  )
}
...
export function useTrackedTokenPairs(): [Token, Token][] {
  ...
  return useMemo(() => {
    ...
    console.log("combine",combinedList)
    const keyed = combinedList.reduce<{ [key: string]: [Token, Token] }>((memo, [tokenA, tokenB]) => {
      const sorted = tokenA?.sortsBefore(tokenB)
    console.log("tokenA",tokenA,"tokenB",tokenA)
