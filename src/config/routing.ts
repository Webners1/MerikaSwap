...
import { ChainId, SUSHI, Token, WNATIVE } from "@core-sdk"
...
import * as OPBNB from './tokens/opbnb'
...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.BSC]: {
    ...
    [BSC.AOT.address]: [BSC.FRAX],
    [BSC.AOT.address]: [BSC.FXS],
  },
  [ChainId.AVALANCHE]: {
