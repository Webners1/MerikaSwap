...
(function (ChainId) {
  ...
  ChainId[ChainId["BOBA_AVAX"] = 43288] = "BOBA_AVAX";
})(ChainId || (ChainId = {}));
...
var opBNB = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(opBNB, _NativeCurrency);

  function opBNB(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'BNB', 'BNB') || this;
  }

  opBNB.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new opBNB(chainId);
  };

  var _proto = opBNB.prototype;
...
var Boba = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Boba, _NativeCurrency);

  function Boba(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'BOBA', 'Boba') || this;
  }

  Boba.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Boba(chainId);
  };

  var _proto = Boba.prototype;
...
var _NATIVE;
var NATIVE = (_NATIVE = {}, _NATIVE[ChainId.ETHEREUM] = /*#__PURE__*/Ether.onChain(ChainId.ETHEREUM), _NATIVE[ChainId.ROPSTEN] = /*#__PURE__*/Ether.onChain(ChainId.ROPSTEN), _NATIVE[ChainId.OPBNB] = /*#__PURE__*/opBNB.onChain(ChainId.OPBNB), _NATIVE[ChainId.RINKEBY] = /*#__PURE__*/Ether.onChain(ChainId.RINKEBY), _NATIVE[ChainId.GÖRLI] = /*#__PURE__*/Ether.onChain(ChainId.GÖRLI), _NATIVE[ChainId.KOVAN] = /*#__PURE__*/Ether.onChain(ChainId.KOVAN), _NATIVE[ChainId.FANTOM] = /*#__PURE__*/Fantom.onChain(ChainId.FANTOM), _NATIVE[ChainId.FANTOM_TESTNET] = /*#__PURE__*/Fantom.onChain(ChainId.FANTOM_TESTNET), _NATIVE[ChainId.MATIC] = /*#__PURE__*/Matic.onChain(ChainId.MATIC), _NATIVE[ChainId.MATIC_TESTNET] = /*#__PURE__*/Matic.onChain(ChainId.MATIC_TESTNET), _NATIVE[ChainId.XDAI] = /*#__PURE__*/xDai.onChain(ChainId.XDAI), _NATIVE[ChainId.BSC] = /*#__PURE__*/Binance.onChain(ChainId.BSC), _NATIVE[ChainId.BSC_TESTNET] = /*#__PURE__*/Binance.onChain(ChainId.BSC_TESTNET), _NATIVE[ChainId.ARBITRUM] = /*#__PURE__*/Ether.onChain(ChainId.ARBITRUM), _NATIVE[ChainId.ARBITRUM_TESTNET] = /*#__PURE__*/Ether.onChain(ChainId.ARBITRUM_TESTNET), _NATIVE[ChainId.AVALANCHE] = /*#__PURE__*/Avalanche.onChain(ChainId.AVALANCHE), _NATIVE[ChainId.AVALANCHE_TESTNET] = /*#__PURE__*/Avalanche.onChain(ChainId.AVALANCHE_TESTNET), _NATIVE[ChainId.HECO] = /*#__PURE__*/Heco.onChain(ChainId.HECO), _NATIVE[ChainId.HECO_TESTNET] = /*#__PURE__*/Heco.onChain(ChainId.HECO_TESTNET), _NATIVE[ChainId.HARMONY] = /*#__PURE__*/Harmony.onChain(ChainId.HARMONY), _NATIVE[ChainId.HARMONY_TESTNET] = /*#__PURE__*/Harmony.onChain(ChainId.HARMONY_TESTNET), _NATIVE[ChainId.OKEX] = /*#__PURE__*/Okex.onChain(ChainId.OKEX), _NATIVE[ChainId.OKEX_TESTNET] = /*#__PURE__*/Okex.onChain(ChainId.OKEX_TESTNET), _NATIVE[ChainId.CELO] = /*#__PURE__*/Celo.onChain(ChainId.CELO), _NATIVE[ChainId.PALM] = /*#__PURE__*/Palm.onChain(ChainId.PALM), _NATIVE[ChainId.MOONRIVER] = /*#__PURE__*/Movr.onChain(ChainId.MOONRIVER), _NATIVE[ChainId.FUSE] = /*#__PURE__*/Fuse.onChain(ChainId.FUSE), _NATIVE[ChainId.TELOS] = /*#__PURE__*/Telos.onChain(ChainId.TELOS), _NATIVE[ChainId.MOONBEAM] = /*#__PURE__*/Glmr.onChain(ChainId.MOONBEAM), _NATIVE[ChainId.OPTIMISM] = /*#__PURE__*/Ether.onChain(ChainId.OPTIMISM), _NATIVE[ChainId.KAVA] = /*#__PURE__*/Kava.onChain(ChainId.KAVA), _NATIVE[ChainId.METIS] = /*#__PURE__*/Metis.onChain(ChainId.METIS), _NATIVE[ChainId.ARBITRUM_NOVA] = /*#__PURE__*/Ether.onChain(ChainId.ARBITRUM_NOVA), _NATIVE[ChainId.BOBA_AVAX] = /*#__PURE__*/Boba.onChain(ChainId.BOBA_AVAX), _NATIVE);
